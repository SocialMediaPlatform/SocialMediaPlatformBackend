...
public class UserController {
    ...
    public ResponseEntity<?> changePassowrd(@RequestBody ChangePasswordRequest changePasswordRequest,
            @RequestHeader(name = "Authorization") String token) {
        try {
            userService.setPassword(jwtService.extractUserId(token.split(" ")[1].trim()),
